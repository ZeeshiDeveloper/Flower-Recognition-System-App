...
const HomePage = ({ navigation }: any) => {
  ...
  const handleUpload = async (e: any) => {
    ...
    // 	},
    // 	body: imageData, // body: JSON.stringify({ imageData }),
    // };
    // fetch("https://e731-119-73-101-69.in.ngrok.io/upload", requestOPt)
    // 	.then((res) => {
    // 		res.json();
    ...
    // 	});
    await fetch("https://1e07-119-73-101-73.ap.ngrok.io/upload", {
      method: "POST",
      headers: {
        Accept: "application/json",
  ...
  const handleSubmit = async (e: any) => {
    await fetch("https://e731-119-73-101-69.in.ngrok.io/name", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-type": "application/json; charset=UTF-8",
